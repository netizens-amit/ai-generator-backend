...
var EnhancedPromptBuilderService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.EnhancedPromptBuilderService = void 0;
...
const design_systems_1 = require("../prompts/design-systems");
let EnhancedPromptBuilderService = EnhancedPromptBuilderService_1 = class EnhancedPromptBuilderService {
    logger = new common_1.Logger(EnhancedPromptBuilderService_1.name);
    async buildEnhancedPrompt(preferences) {
        if (preferences.codeType === generate_website_dto_1.CodeType.REACT) {
            return this.buildReactPrompt(preferences);
        }
        else {
...
exports.EnhancedPromptBuilderService = EnhancedPromptBuilderService;
exports.EnhancedPromptBuilderService = EnhancedPromptBuilderService = EnhancedPromptBuilderService_1 = __decorate([
    (0, common_1.Injectable)()
], EnhancedPromptBuilderService);
//# sourceMappingURL=enhanced-prompt-builder.service.js.map